...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { desc: @genre.desc, photo_url: @genre.photo_url, title: @genre.title } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { desc: @genre.desc, photo_url: @genre.photo_url, title: @genre.title } }
