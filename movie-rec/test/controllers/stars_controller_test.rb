...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { bio: @star.bio, fname: @star.fname, lname: @star.lname, photo_url: @star.photo_url } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { bio: @star.bio, fname: @star.fname, lname: @star.lname, photo_url: @star.photo_url } }
